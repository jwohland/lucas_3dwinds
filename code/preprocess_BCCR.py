...
for experiment in ["EVAL", "FOREST", "GRASS"]:
    ...
    for year in years:
        ...
        ds_ua = ds_ua.where(ds_ua["U"] < 1e+10)  # merge and mask really high values signifying nans as nans
        ...
        ds_va = ds_va.where(ds_va["V"] < 1e+10)  # mask really high values signifying nans as nans
