...
for experiment in ["FOREST", "GRASS"]:
    for institution in ["NORCE", "GERICS", "ETH", "IDL", "OUR"]:  # todo include JLU once preprocessed
        print(institution)
    ...
    # repeat for S_10 ETH  # todo check if 10m wind components should also be computed for other models
